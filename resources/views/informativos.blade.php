                ...
                <div class="row row-cols-1 row-cols-md-4 g-0 w-100" > <!-- Sem espaçamento extra -->
                        ...
                        <div class="col" style="padding:5px">
                            <div class="card p-3 shadow-sm border-0">
                                <div class="card-body">
                                    <p class="text-primary fw-bold">Postos de saude</p>
                                    <h5 class="fw-bold">Cooperação</h5>
                                    <span class="badge bg-primary">Ajudas</span>
                            ...
                            <div class="card p-3 shadow-sm border-0">
                                <div class="card-body">
                                    <p class="text-primary fw-bold">Fornecimento de Remédio</p>
                                    <h5 class="fw-bold">Remédios</h5>
                                    <span class="badge bg-primary">Remédios</span>
                        ...
                        <div class="col" style="padding:5px">
                            <div class="card p-3 shadow-sm border-0">
                                <div class="card-body">
                                    <p class="text-primary fw-bold">Doenças contagiosas</p>
                                    <h5 class="fw-bold">Gripe (Influenza)</h5>
                                    <span class="badge bg-primary">Doenças virais</span>
                        ...
                        <div class="card p-3 shadow-sm border-0">
                            <div class="card-body">
                                <p class="text-primary fw-bold">Doação de Sangue</p>
                                <h5 class="fw-bold">Doação</h5>
                                <span class="badge bg-primary">Doação de Sangue</span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <label for="email"><b>Nome da Clinica </b></label>
                                        <input class="form-control" type="text" name="rua" value="Clinica Interlagos MSP" disabled readonly>
                                    
                                    <label for="email"><b>Rua</b></label>
                                        <input class="form-control" type="text" name="rua" value="R. Barão do Rio Branco, 303" disabled readonly>

                                    <label for="email"><b>Data</b></label>
                                        <input class="form-control" type="date" name="data" value="2025-02-19">

                                    <label for="email"><b>Hora</b></label>
                                        <input class="form-control"  type="time" name="hora" value="18:00">
